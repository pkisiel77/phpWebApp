                                    ...
                                    <table id="tabledata" class="table table-striped" style="width:100%">
                                        ...
                                        <?php foreach ($data
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" name="wh"
                                                            class="btn btn-primary change-button"
                                                            data-toggle="modal"
                                                            data-target="<?php echo "#modal" . $row['userID'] ?>">Change
                                                    </button>
                                                </td>
                                            </tr>

                                            <div class="modal fade" id="<?php echo "modal" . $row['userID'] ?>"
                    ...
                    <div class='mb-3'>
                     ...
                     <input type='number' max='1' min='0' class='form-control' id='status' name='status" . $row['userID'] . "' maxlength='1' value='" . $row['status'] . "' required></input>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit"
                                                                        form="<?php echo "myForm" . $row['userID'] ?>"
                                                                        class="btn btn-primary" value="Save Changes"
                                                                        name="ws">Save Changes
                                                                </button>
