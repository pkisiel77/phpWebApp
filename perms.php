                                                    ...
                                                    foreach ($data as $row): ?>
                                                        <td>
                                                            <?php if ($row['haspermission'] == true): ?>
                                                                <input type="checkbox"
                                                                       name="permission_checkbox<?= $row['roleID'] ?>"
                                                                       value="<?= $row['permissionID'] ?>" checked>
                                                            <?php else: ?>
                                                                <input type="checkbox"
                                                                       name="permission_checkbox<?= $row['roleID'] ?>"
                                                        ...
                                                        <input type="hidden" name="lgn"
                                                               value="<?php echo $row['roleID']; ?>">
                                                    <?php endforeach ?>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tbody>
                                        </table>
                                        <input class="btn btn-dark w-100" value="<?= $translations['submit'] ?>"
                                               type="submit" name="wa"></input>
                                </div>
                            </div>
                        </div>
                    </div>
